...
use types::{
    ...
    gloas::{
        consts::{BUILDER_INDEX_FLAG, BUILDER_WITHDRAWAL_PREFIX},
...
#[must_use]
pub const fn is_builder_index(validator_index: ValidatorIndex) -> bool {
...
pub fn is_attestation_same_slot<P: Preset>(
    ...
    let is_matching_blockroot = data.beacon_block_root == get_block_root_at_slot(state, data.slot)?;
