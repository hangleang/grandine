...
use types::{
    ...
    preset::Preset,
    traits::{AttesterSlashing, BeaconState, PostGloasBeaconBlockBody, PostGloasBeaconState},
};
...
pub fn process_operations<P: Preset, V: Verifier>(
    ...
    // TODO(gloas): change to `electra::process_attester_slashing` once compatible
...
pub fn process_proposer_slashing<P: Preset>(
    ...
    // TODO(gloas): use `electra::slash_validator` once compatible
    slash_validator(
        config,
        state,
        index,
...
// TODO(gloas): remove this function, reuse `electra::process_attester_slashing`
